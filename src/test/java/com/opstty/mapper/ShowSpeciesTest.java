...
public class ShowSpeciesTest {
    @Mock
    private Mapper.Context context;
    private ShowSpeciesMapper showSpeciesMapper;

    @Before
    public void setup() {
        this.showSpeciesMapper = new ShowSpeciesMapper();
    }
    ...
    public void testMap() throws IOException, InterruptedException {
        ...
        this.showSpeciesMapper.map(null, new Text(value), this.context);
        this.showSpeciesMapper.map(null, new Text(value2), this.context);
        this.showSpeciesMapper.map(null, new Text(value3), this.context);
